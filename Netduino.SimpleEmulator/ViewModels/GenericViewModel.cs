...
namespace Netduino.SimpleEmulator.ViewModels
{
    ...
    public class GenericViewModel : Screen,IEmulatorViewModel, IHandle<OutputGpioEventArgs>
	{
        ...
        /// <summary>
        /// The current state of the Netduino On Board LED
        /// </summary>
        ...
        /// <summary>
        /// Handle any messages coming from the simulated netduino hardware
        /// </summary>
